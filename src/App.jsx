...
const App = () => {
  ...
  const SidebarFilters = () => (
    <div className="sidebar-filters" style={{ background: 'white', border: '1px solid #e5e7eb', borderRadius: '12px', padding: '25px', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)', height: 'fit-content' }}>
  ...
  const SidebarSort = () => (
    <div className="sidebar-sort" style={{ background: 'white', border: '1px solid #e5e7eb', borderRadius: '12px', padding: '25px', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)', height: 'fit-content' }}>
